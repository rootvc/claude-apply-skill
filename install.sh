...
echo "  2. First, say: 'Read ~/.claude/skills/root-ventures-apply/prompt.txt'"
echo "  3. Then say: 'I want to apply to Root Ventures'"
echo "  4. Claude will guide you through the application process"
echo ""
echo "💡 Tip: Claude needs to read the prompt file first to understand the skill"
echo ""
echo "Learn more:"
echo "  https://root.vc"
echo ""
